<?php
  ...
  if(isset($_POST["CrsName"]) && isset($_POST["Discrption"]))
  {
    if(!empty($_POST["CrsName"]) && !empty($_POST["Discrption"]))
    {
        $course = new Course;

        $course->setCrsName($_POST["CrsName"]);
        $course->setDescription($_POST["Discrption"]);

        $errmsg = $CrsController->AddCourse($course);
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="InputName" placeholder="Name" name = "CrsName">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1" style="font-size : 20px">Discrption</label>
                        <textarea cols="30" rows="5" class="form-control" placeholder="Discrption" name="Discrption"></textarea>
                      </div>
